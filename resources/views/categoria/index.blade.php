        ...
        <tr>
            ...
            <td>
                <form action="{{route ('categorias.destroy', $categoria->id)}}" class="formulario-eliminar" method="POST">
                   @can('categoria.show')
                   <a href="{{route('categorias.show', $categoria->id)}}" class="btn btn-info"><i class="fas fa-info-circle"></i></a>
                   @endcan
                   @can('categoria.edit')
                   <a href="/categorias/{{$categoria->id}}/edit" class="btn btn-primary" ><i class="far fa-edit"></i></a>
                   @endcan
                   @csrf
                   @method('DELETE')
